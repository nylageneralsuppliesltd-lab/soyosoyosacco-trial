// docs/scripts/projections.js — FINAL GOLD VERSION: NEW LOGIC + ORIGINAL BEAUTY
(function () {
  'use strict';
  ...
  function fmt(num) {
    ...
    return n >= 1000000 ? `KES ${(n / 1000000).toFixed(1)}M` : n.toLocaleString();
  }
  ...
  function createCharts() {
    ...
    // RESTORED ORIGINAL SUMMARY CARD
    ...
    summary.innerHTML = `
      ...
      <div class="summary-grid">
        ...
        <div class="summary-item">
          ...
          <div class="summary-values">
            <span>${new Date().getFullYear()}</span><strong>KES ${fmt(current.contributions)}</strong>
            <span>${last.year}</span><strong>KES ${fmt(last.contributions)}</strong>
          </div>
        ...
        <div class="summary-item">
          ...
          <div class="summary-values">
            <span>${new Date().getFullYear()}</span><strong>KES ${fmt(current.loans)}</strong>
            <span>${last.year}</span><strong>KES ${fmt(last.loans)}</strong>
          </div>
        ...
        <div class="summary-item">
          ...
          <div class="summary-values">
            <span>${new Date().getFullYear()}</span><strong>KES ${fmt(current.bankBalance)}</strong>
            <span>${last.year}</span><strong>KES ${fmt(last.bankBalance)}</strong>
          </div>
    ...
    // RESTORED YOUR ORIGINAL STUNNING STYLES
